...
function MovieListPage() {
  ...
  return (
      <div className="bg-black min-h-screen ">
        <nav className="bg-black border-gray-200 dark:border-gray-600 dark:bg-gray-900">
          <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
            <a href="" className="flex items-center space-x-3 rtl:space-x-reverse">
              <h1 class="text-6xl font-bold text-white mb-1">Movie<span class="text">Strom</span>
              </h1>
            </a>
              ...
              <ul className="flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-black dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                ...
                <li>
                  <button id="mega-menu-full-dropdown-button" data-collapse-toggle="mega-menu-full-dropdown"
                          ...
                          aria-controls="mega-menu-full-dropdown" aria-expanded="false">Categeroy <svg
                ...
                <li>
                  <a href="#"
                     className="block py-2 px-3 text-white rounded hover:text-yellow-300 md:hover:bg-transparent md:hover:text-yellow-300 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">Movies</a>
                </li>
                <li>
                  <a href="#"
                     className="block py-2 px-3 text-white rounded hover:text-yellow-300 md:hover:bg-transparent md:hover:text-yellow-300 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">Webserise</a>
                </li>
          ...
          <div id="mega-menu-full-dropdown"
            ...
            <div className="grid max-w-screen-xl px-4 py-5 mx-auto text-white dark:text-white sm:grid-cols-3 md:px-6">
              <ul>
                <li>
                  <a href="#" className="block p-3 rounded-lg hover:text-yellow-300 dark:hover:bg-gray-700 border border-black border-1">
              ...
              <ul>
                ...
                <li>
                  <a href="#" className="block p-3 rounded-lg hover:text-yellow-300 dark:hover:bg-gray-700 border-black border-1">
        ...
        <div className='mt-7'>
          <div>
            <h3 className='text-6xl font-serif text'>TOP VIEWED</h3></div>
        ...
        <br/>
        <div className='mt-7'>
          <div><h3 className='text-6xl font-serif text'>
            RECOMMENDED
          </h3></div>
        ...
        <div className='mt-7'>
          <div>
            <h3 className='text-6xl font-serif text'>

              LATEST-RELEASE</h3></div>
          <hr className="text border-2"/>
        </div>
        ...
        {isLoading && (
            <div
                className="fixed z-10 inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center w-full h-full">
              <div className="animate-spin rounded-full h-16 w-16 border-t-4 border-white border-opacity-25"></div>
            </div>
        )}
        <div
            className=" container mx-auto mt-8 px-4 grid gap-4 grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6">
          {movies.map((movie) => (
              <Link
                  to={`/movie/${movie.CID}`}
                  key={movie.CID}
              ...
              >
                <div
                    className="relative overflow-hidden transition-transform duration-200 transform hover:scale-105 hover:z-10 border-2 border-black transition duration-300 hover:border-yellow-500 rounded-lg">
                  <img
